...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_btn_1_label, "Open");
	lv_label_set_long_mode(ui->screen_btn_1_label, LV_LABEL_LONG_WRAP);
	lv_obj_align(ui->screen_btn_1_label, LV_ALIGN_CENTER, 0, 0);
	lv_obj_set_style_pad_all(ui->screen_btn_1, 0, LV_STATE_DEFAULT);
	lv_obj_set_pos(ui->screen_btn_1, 74, 148);
	lv_obj_set_size(ui->screen_btn_1, 281, 74);
	...
	lv_label_set_text(ui->screen_btn_2_label, "Close");
	lv_label_set_long_mode(ui->screen_btn_2_label, LV_LABEL_LONG_WRAP);
	lv_obj_align(ui->screen_btn_2_label, LV_ALIGN_CENTER, 0, 0);
	lv_obj_set_style_pad_all(ui->screen_btn_2, 0, LV_STATE_DEFAULT);
	lv_obj_set_pos(ui->screen_btn_2, 389, 153);
	lv_obj_set_size(ui->screen_btn_2, 316, 69);
